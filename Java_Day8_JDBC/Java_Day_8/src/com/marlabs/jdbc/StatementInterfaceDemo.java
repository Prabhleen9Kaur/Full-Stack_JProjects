...
public class StatementInterfaceDemo {
	public static void main(String[] args) {
		...
		System.out.println("2) Display Department Employee Details Module With RSMD");
		...
		try {
			...
			case 4:
				...
				departmentNumber = scanner.nextInt();
				boolean registrationFlag = statementAPIExample.registerEmployee(empNumber, empName, empSalary,
						departmentNumber);
				if (registrationFlag) {
